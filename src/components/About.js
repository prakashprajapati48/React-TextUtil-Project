...
export default function About() {
    ...
    const [btnText,setBtnButton] = useState('Enable light mode')
    ...
    const modechange = () => {
        if (myStyle.color === 'black') {
            ...
            setBtnButton('Enable light mode')
        }
    ...
    return (
        <div className='container' style={myStyle} >
            ...
            <button className='btn btn-primary my-2' onClick={modechange}>{btnText}</button>
        </div>
    )
}
